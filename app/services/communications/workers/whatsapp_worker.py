"""WhatsApp worker — consumes outbox messages and sends via WhatsApp provider."""
import asyncio
...
class WhatsAppWorker:
    """Processes WhatsApp outbox messages."""
    ...
    def run_once(self, batch_size: int = 20) -> int:
        ...
        try:
            ...
            outbox_ids = repo.dequeue_by_channel("whatsapp", batch_size=batch_size)
            processed = 0
